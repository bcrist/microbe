...
//     fn handleSetupOutBuffer(setup: SetupPacket, offset: u16, data: []volatile const u8) bool
...
//     fn startTransferIn(ep: endpoint.Index, len: u16, pid: PID) void
//     fn startTransferOut(ep: endpoint.Index, len: u16, pid: PID) void
